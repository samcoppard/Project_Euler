...
N.B. This solution is long and messy, and the first part (actually getting the grid of
numbers into the format I wanted) is worse than the refactored version. But the other
part (figuring out the answer) is actually faster than the refactored version, but it's
a lot longer and less readable too.
"""
...
for row in a:
    original_grid.append([int(i) for i in row.split(" ")])
