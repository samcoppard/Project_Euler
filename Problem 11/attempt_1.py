...
#Getting the grid into a usable structure is awkward enough - going for a list of 20 lists of 20 numbers each
...
#Create the list to contain the other lists
grid = []

#Create a function to turn each row of numbers into a list, then add them to the grid, and keep going until all 400 numbers are in there
def twenty_at_a_time(start, end):
    line_of_twenty = []
    for i in range(start, end):
        line_of_twenty.append(int(numbers[i])) #Got to turn the number-strings back into actual numbers
