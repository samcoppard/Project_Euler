# Is it faster to go through each of the nxn grids sequentially, up to 20x20, or go
# straight to 20x20?

# Answer: Essentially no difference
...
improvement = fast_code_time / slow_code_time
